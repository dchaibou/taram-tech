...
export const metadata: Metadata = {
  title: "Nos Services | Taramtech",
  description: "Développement de sites internets, applications mobiles et applications web sur mesure.",
};
...
const servicesData = [
  {
    ...
    description: "Conception de plateformes vitrines ou d'entreprise ultra-rapides, optimisées pour le SEO.",
  },
  {
    icon: DevicePhoneMobileIcon,
    title: "Applications mobiles",
    description: "Création d'applications intuitives et performantes pour iOS et Android. Une solution unique pour toucher tous vos utilisateurs.",
  },
  {
    icon: CodeBracketIcon,
    title: "Applications web",
    description: "Développement de solutions complexes robustes, sécurisées, et parfaitement adaptées à la croissance de votre startup.",
  },
];
      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-400">
            L&apos;excellence technique est notre standard, la performance votre avantage.
          </p>
        </div>
        ...
        <div className="mt-20 p-8 bg-gray-900 rounded-xl border border-indigo-700/50 text-center">
          ...
          <p className="mt-3 text-lg text-gray-400">
            Notre équipe d&apos;architecture logicielle est prête à relever votre défi unique.
          </p>
          <Link
            href="/contact"
